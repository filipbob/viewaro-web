...
const nl: Dictionary = {
  ...
  home: {
    ...
    metaDescription:
      "Viewaro is een native IPTV-speler voor macOS 15+. Importeer je eigen M3U/M3U8-playlist en speel streams af waarvoor je toegang hebt.",
    eyebrow: "Viewaro Player",
    heroLine1: "Jouw content.",
    heroLine2: "Jouw scherm.",
    heroSub:
      "Viewaro is een native IPTV-speler voor Mac. Importeer je eigen M3U/M3U8-playlist en speel streams af waarvoor je toegang hebt. Viewaro levert geen zenders, playlists of media-abonnementen.",
    badge: "Huidige versie: macOS 15+",
    plannedPlatforms:
      "Gepland: iPhone, iPad, Apple TV, Android en Android TV. Deze platforms zijn niet beschikbaar in de huidige macOS-versie.",
    ...
    features: [
      ...
      {
        title: "Jouw M3U-playlist",
        body: "Importeer een compatibele M3U- of M3U8-playlist van een aanbieder die je mag gebruiken.",
      },
      {
      ...
      },
      {
        ...
        body: "Playlistgegevens, inloggegevens, favorieten en instellingen blijven op je Mac. Er is geen Viewaro-account of cloudsynchronisatie.",
      },
      {
        title: "Ouderlijk toezicht",
        body: "Een viercijferige pincode beschermt profielbeheer en het verlaten van een kinderprofiel; beperkte categorieën blijven daar verborgen.",
      },
      {
        title: "Gemaakt voor Mac",
        body: "Een native macOS 15+-ervaring met vertrouwde Mac-bediening, toetsenbordnavigatie en lokale opslag.",
      },
    ],
    integrationsEyebrow: "Op de routekaart",
    integrationsHeading: "Films & series",
    integrationsSub: "Geplande functie — niet beschikbaar in macOS 1.0.",
    integrations: [
      {
        name: "TMDB",
    ...
    steps: [
      {
        ...
        body: "Installeer de huidige versie op een Mac met macOS 15 of nieuwer.",
      },
      {
        step: "02",
        title: "Voeg je playlist toe",
        body: "Plak het adres van je eigen M3U- of M3U8-playlist. Je geïmporteerde zenders verschijnen binnen enkele seconden.",
      },
      {
        step: "03",
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "De huidige versie ondersteunt Macs met macOS 15 of nieuwer. iPhone, iPad, Apple TV, Android en Android TV zijn gepland, maar niet beschikbaar in macOS 1.0.",
      },
      {
        q: "Welke playlistformaten kan ik gebruiken?",
        a: "De huidige versie importeert M3U- en M3U8-playlists. Je kunt ook een optioneel XMLTV-gidsadres opgeven. Xtream Codes-accounts en handmatige zenderinvoer zijn niet beschikbaar in macOS 1.0.",
      },
      {
        q: "Heb ik een account nodig?",
        a: "Nee. macOS 1.0 heeft geen Viewaro-account, aanmelding of cloudsynchronisatie. Je playlists, favorieten, profielen en instellingen blijven op je Mac.",
      },
      {
        q: "Hoe werkt Viewaro Premium?",
        a: "Viewaro Premium is een automatisch verlengbaar Apple-abonnement in de app van € 4,99 per maand. Het ontgrendelt meerdere IPTV-bronnen en profielen. Apple toont de lokale prijs vóór aankoop en verwerkt facturering, opzegging en terugbetalingen.",
      },
    ],
    ctaHeading: "Huidige versie: macOS 1.0",
    ctaBody:
      "Voor macOS 15 en nieuwer. Je brengt je eigen M3U/M3U8-playlist mee; Viewaro levert geen zenders of media-abonnementen.",
  },
  legal: {
    updatedLabel: "Ingangsdatum:",
    privacy: {
      title: "Privacybeleid",
    ...
    support: {
      ...
      sections: [
        {
          paragraphs: [
            "Viewaro 1.0 is een native IPTV-speler voor Macs met macOS 15 of nieuwer. De app importeert je M3U/M3U8-playlists en speelt compatibele streams af. Er is geen gebruikersaccount of cloudsynchronisatie; Viewaro bevat geen zenders, playlists of media-abonnementen.",
          ],
        },
        {
          heading: "Contact",
        ...
        },
        {
          ...
          topics: [
            ...
            },
            {
              ...
              a: "De gratis versie ondersteunt één IPTV-bron, één profiel en volledige weergave. Viewaro Premium kost € 4,99 per maand en ontgrendelt meerdere IPTV-bronnen en profielen. De App Store toont vóór aankoop de gelokaliseerde prijs.",
            },
            {
              q: "Hoe herstel of zeg ik Premium op?",
              a: "Open Viewaro-instellingen > Abonnement en kies Aankopen herstellen. Gebruik daar Abonnement beheren, indien beschikbaar, of de abonnementsinstellingen van je Apple-account om te beheren of op te zeggen. Het verwijderen van Viewaro zegt het abonnement niet op.",
            },
            {
              q: "Hoe werken ouderlijk toezicht en de pincode?",
              a: "Open Viewaro-instellingen > Ouderlijk toezicht om een viercijferige pincode in te stellen, te wijzigen of uit te schakelen. De pincode beschermt profielbeheer en het verlaten van een kinderprofiel. Als je de code vergeet, kan Viewaro die niet in de app resetten. Sluit en verwijder Viewaro, kies in Finder Ga > Ga naar map en verplaats ~/Library/Containers/hr.itquotes.viewaro naar de prullenmand voordat je opnieuw installeert. Dit verwijdert lokale playlists, inloggegevens, favorieten, profielen en instellingen permanent; Premium wordt niet opgezegd.",
            },
            {
